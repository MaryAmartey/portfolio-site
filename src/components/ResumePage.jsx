  ...
  return (  
    ...
    <li className="mb-10 ml-4">
        ...
        <li className="mb-2 ml-4">
            ...
            <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September 2023 - Present</time>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Associate Developer at AKQA</h3>
        </li>           
        <li className="mb-10 ml-4">
            <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">June 2023 - August 2023</time>
            <h3 className="text-md font-semibold text-gray-900 dark:text-white">Technology Intern at AKQA</h3>
