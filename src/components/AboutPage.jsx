      ...
      <div className="max-w-md md:mt-44 md:pt-6 pt-36 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-800 dark:hover:bg-gray-900">
        ...
        <div className="divide-y divide-gray-600 ">
          ...
          <div className="px-1 py-2">
            ...
            <span className="block text-sm  text-blue-500 truncate dark:text-blue-700">maryamartey123@yahoo.com</span>
            <div className="flex divide-x  socials">
          <a href="https://www.facebook.com/mary.amartey.528">
            <svg class="mr-1 w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
              <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
            </svg>
          </a>
            <a href="https://www.linkedin.com/in/mary-amartey-0388a9185">
              <svg class="w-4 h-4 mx-2 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15">
                <path fill-rule="evenodd" d="M7.979 5v1.586a3.5 3.5 0 0 1 3.082-1.574C14.3 5.012 15 7.03 15 9.655V15h-3v-4.738c0-1.13-.229-2.584-1.995-2.584-1.713 0-2.005 1.23-2.005 2.5V15H5.009V5h2.97ZM3 2.487a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" clip-rule="evenodd"/>
                <path d="M3 5.012H0V15h3V5.012Z"/>
              </svg>
              </a>
               <a href="">
                    <svg class="w-4 h-4 mx-2 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
