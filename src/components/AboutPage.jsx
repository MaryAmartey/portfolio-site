              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <p className="text-white/90 text-sm sm:text-base leading-relaxed">
                    ...
                    innovative solutions for real-world challenges. With
                    expertise in both front-end and back-end development, I
                    specialize in building efficient, scalable applications that
                    make a difference.
                  </p>
                  <p className="text-white/90 text-sm sm:text-base leading-relaxed">
                    My journey in tech is driven by an insatiable curiosity for
                    emerging trends and a commitment to continuous learning. I
                    thrive in dynamic environments where I can apply my
                    expertise in modern frameworks and agile methodologies to
                  ...
                  <div className="pt-4 sm:pt-6 border-t border-white/20">
                    <div className="flex flex-col space-y-2 sm:space-y-3">
                      ...
                      >
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-blue-400 group-hover:text-blue-300"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
